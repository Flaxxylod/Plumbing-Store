...
const MenuButton = ({ Click, }) => {
    return (
        <button d onClick={Click} className="border border-[#494949] border-[1px] rounded-[2px] p-[12px] lg:hidden inline-flex items-center gap-x-[12px] max-w-[95px] max-h-[32px]">
